    ...
    <div id="contact" className="max-w-[1140px] m-auto w-full px-4 py-16">
      ...
      <div className="grid md:grid-cols-2">
        <img
          ...
          src="https://images.unsplash.com/photo-1611222565146-f0e39f5217f7?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80"
          alt="/"
        />
        <form>
